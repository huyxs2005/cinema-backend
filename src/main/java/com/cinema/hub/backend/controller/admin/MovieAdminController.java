...
public class MovieAdminController {
    ...
    @GetMapping
    public List<MovieAdminResponseDto> getMovies(@RequestParam(required = false) String keyword,
                                                 @RequestParam(required = false) String status,
                                                 @RequestParam(required = false) String genre,
                                                 @RequestParam(required = false, name = "durationOrder") String durationOrder,
                                                 @RequestParam(required = false, name = "ageRating") String ageRating) {
        return movieAdminService.getAll(keyword, status, genre, durationOrder, ageRating);
    }
