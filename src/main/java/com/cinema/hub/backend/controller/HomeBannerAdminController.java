...
public class HomeBannerAdminController {
    ...
    @GetMapping
    public List<HomeBannerResponseDto> getAllBanners(@RequestParam(required = false) String keyword,
                                                     @RequestParam(required = false) Boolean active) {
        return homeBannerService.getAllBannersForAdmin(keyword, active);
    }
